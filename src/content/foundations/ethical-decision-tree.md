...
description: "A structured decision-making guide for the gray areas of AI use in SLP practice."
...
5. **Does my employer or district have a policy on AI use?** If yes, that policy supersedes anything here. If no, you're still bound by HIPAA, FERPA, and ASHA's Code of Ethics <cite data-ref="asha-ethics-2023"></cite>.
    ...
    - **Yes** → Is there a signed BAA with this AI provider?
      ...
      - **Yes** → Is the task documentation, goal writing, or report generation?
        ...
        - **No** → Is the task clinical decision-making (diagnosis, eligibility, treatment planning)?
          - **Yes** → **Do not use AI for this task.** These require independent professional judgment <cite data-ref="asha-ethics-2023"></cite>.
