---
title: "Suck-Swallow-Breathe Coordination — NICU/Preterm Infant"
description: "Demonstrate coordinated suck-swallow-breathe pattern during nipple feeding (breast or bottle), supporting transition from gavage to oral feeding in a preterm or medically complex infant."
domain: dysphagia
subdomain: "pediatric feeding — NICU / preterm"
settings: [medical]
populations: [pediatric]
ageRange: "preterm infants ~32-40 weeks PMA"
supportLevel: maximum
severity: severe
neurodiversityAffirming: false
fourQuestions:
  conditions: "During nipple feedings (breast or bottle, with developmentally appropriate flow rate / paced feeding as indicated) using a cue-based feeding approach, with infant in stable physiologic state (HR, RR, SpO2 within parameters) and positioned for elongated trunk and tucked chin"
  behavior: "Infant will demonstrate a coordinated suck-swallow-breathe rhythm (typically 1:1:1 in mature feeders, with periodic breathing breaks acceptable in less mature feeders) without prolonged desaturation, bradycardia, or apnea events"
  criteria: "across at least 2 consecutive feedings per day for 3 consecutive days, taking at least 50% of prescribed volume orally without physiologic compromise, with successful intake AND physiologic stability both required"
...
evidenceBase:
  ...
  - source: "Ross, E.S., & Philbin, M.K. (2011). Supporting oral feeding in fragile infants: An evidence-based method for quality bottle-feedings of preterm, ill, and fragile infants. Journal of Perinatal & Neonatal Nursing, 25(4)."
  - source: "Pickler, R.H., Best, A., & Crosson, D. (2009). The effect of feeding experience on clinical outcomes in preterm infants. Journal of Perinatology, 29(2)."
  - source: "Fucile, S., Gisel, E.G., & Lau, C. (2002). Oral stimulation accelerates the transition from tube to oral feeding in preterm infants. Journal of Pediatrics, 141(2)."
  - source: "American Academy of Pediatrics — NICU feeding guidance"
    url: "https://www.aap.org/"
  - source: "Newborn Individualized Developmental Care and Assessment Program (NIDCAP) — developmental care framework"
relatedGoals:
  - "spoon-feeding-transition-infant"
order: 25
---
...
- [Spoon Feeding Introduction and Acceptance — Infant](/goals/dysphagia/spoon-feeding-transition-infant/) — later developmental goal in pediatric feeding (typically post-NICU)
- [Sensory-Based Feeding for Pediatric Oral Aversion](/goals/dysphagia/sensory-feeding-oral-aversion/) — later goal for children with established aversion patterns, which can be a sequela of medically complex early feeding
