...
1. **Under what conditions?** (Given what support, what context?)
2. **What observable behavior?** (What will the student/patient actually do?)
3. **To what measurable criteria?** (How much, how often, how accurately?)
4. **How will you track it?** (What's the measurement method?)
